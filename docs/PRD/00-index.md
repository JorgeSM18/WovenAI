...
| PD-05 | Proveedores externos | No se define proveedor de **clima**, de **eliminación de fondo** ni de **modelos de IA** (clasificación, recomendación, búsqueda semántica). | Bloquea contratos de integración; se proponen requisitos funcionales, no proveedor. |
